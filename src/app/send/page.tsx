      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
            ...
            {!isSuccess ? (
              ...
              >
                ...
                <div className="relative z-10">
                  <h2 className="font-sans font-bold text-3xl text-[var(--white)] mb-2">رسالة شكرك تُخلَّد للتاريخ</h2>
                  <p className="text-[var(--muted-light)] mb-8">شارك في أكبر حملة توثيق وطنية لرسائل الشكر</p>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="relative group">
                      <input
                        ...
                        className="w-full bg-[var(--input-glass)] border-none border-b-2 border-[var(--border)] text-[var(--text-on-input)] px-4 pt-6 pb-2 focus:ring-0 focus:outline-none focus:border-[var(--gold)] transition-colors peer"
                        placeholder=" "
                      />
                      <label
                        htmlFor="name"
                        className="absolute right-4 top-4 text-[var(--muted)] transition-all peer-focus:-top-1 peer-focus:text-xs peer-focus:text-[var(--gold)] peer-[:not(:placeholder-shown)]:-top-1 peer-[:not(:placeholder-shown)]:text-xs peer-[:not(:placeholder-shown)]:text-[var(--gold)]"
                      >
                        الاسم الكريم
                      </label>
                    </div>
                    ...
                    <div>
                      <label className="block text-[var(--muted)] text-sm mb-3 px-1">الفئة</label>
                      <div className="flex flex-wrap gap-3">
                        {['مواطن', 'مقيم', 'طالب', 'جهة'].map(cat => (
                          <button
                            type="button"
                            key={cat}
                    ...
                    <div className="relative group pt-4">
                      <textarea
                        ...
                        className="w-full bg-[var(--input-glass)] border-none border-b-2 border-[var(--border)] text-[var(--text-on-input)] px-4 pt-6 pb-2 focus:ring-0 focus:outline-none focus:border-[var(--gold)] transition-colors peer resize-none font-serif leading-loose"
                        placeholder=" "
                      ></textarea>
                      <label
                        htmlFor="message"
                        className="absolute right-4 top-8 text-[var(--muted)] transition-all peer-focus:top-0 peer-focus:text-xs peer-focus:text-[var(--gold)] peer-[:not(:placeholder-shown)]:top-0 peer-[:not(:placeholder-shown)]:text-xs peer-[:not(:placeholder-shown)]:text-[var(--gold)]"
                      >
                        رسالتك
                      </label>
                      <div className="absolute left-2 bottom-2 text-xs font-mono text-[var(--muted)]">
                        {formData.message.length}/500
                      </div>
                    </div>

                    <div className="pt-4 border-t border-[var(--border)]">
                      <label className="block text-[var(--muted)] text-sm mb-4 px-1">أو أضف رسالة صوتية (اختياري)</label>
                      {!hasRecorded && !isRecording ? (
                        <div className="flex flex-col items-center justify-center py-6">
                          ...
                          <span className="text-[var(--muted)] text-sm">اضغط للتسجيل</span>
                        </div>
                      ) : isRecording ? (
                        <div className="flex flex-col items-center justify-center py-6">
                        ...
                        <div className="py-4 flex items-center justify-between bg-[var(--surface-2)] px-4 rounded-xl border border-[var(--border)]">
                          ...
                          <button type="button" onClick={() => setHasRecorded(false)} className="text-[var(--red-light)] text-sm font-bold mr-4 hover:underline">حذف</button>
                        </div>
                      )}
                    </div>
              ...
              >
                ...
                <h2 className="font-sans font-black text-3xl text-[var(--gold)] mb-2">تم التوثيق بنجاح!</h2>
                <p className="text-[var(--white)] text-lg mb-8">شكراً {formData.name}، رسالتك ستظل محفورة في تاريخ الوطن.</p>

                {displayId && (
                  <div className="bg-[var(--surface-2)] border border-[var(--gold-dim)] rounded-xl p-6 mb-8 inline-block shadow-inner mx-auto">
                    <p className="text-[var(--muted-light)] text-sm mb-1">رقم التوثيق</p>
        ...
        <div className="w-full lg:w-[40%] flex flex-col gap-6">
          <div className="bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-6 text-center shadow-lg">
            <h3 className="font-sans text-[var(--muted-light)] text-sm font-bold mb-4 uppercase tracking-wider">العداد المباشر</h3>
            <LiveCounter compact />
          </div>
          ...
          <div className="bg-gradient-to-br from-[var(--surface)] to-[var(--surface-2)] border border-[var(--gold-dim)] rounded-2xl p-8 relative overflow-hidden flex-1">
            ...
            <div className="relative z-10">
              <h3 className="font-sans font-bold text-2xl text-[var(--white)] mb-6 border-b border-[var(--border)] pb-4">لماذا رسالتك مهمة؟</h3>
              <ul className="space-y-6">
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-sans font-bold text-[var(--white)] mb-1">دعم معنوي لأبطالنا</h4>
                    <p className="text-[var(--muted-light)] text-sm leading-relaxed">رسالتك تصل مباشرة للقوات المسلحة لترفع من معنوياتهم.</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full bg-[var(--gold-dim)] flex items-center justify-center shrink-0 mt-1">
                  ...
                  <div>
                    <h4 className="font-sans font-bold text-[var(--white)] mb-1">توثيق تاريخي</h4>
                    <p className="text-[var(--muted-light)] text-sm leading-relaxed">ستُحفظ رسالتك في السجل الوطني والكتاب الرقمي.</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full bg-[var(--gold-dim)] flex items-center justify-center shrink-0 mt-1">
                  ...
                  <div>
                    <h4 className="font-sans font-bold text-[var(--white)] mb-1">رقم غينيس</h4>
                    <p className="text-[var(--muted-light)] text-sm leading-relaxed">أنت تساهم في تحقيق رقم قياسي عالمي باسم دولة الإمارات.</p>
                  </div>
                </li>
              </ul>
            </div>
