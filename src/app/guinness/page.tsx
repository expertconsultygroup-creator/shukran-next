    ...
    <div className="min-h-screen bg-[var(--bg-deep)] text-[var(--white)] relative">
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="text-center max-w-4xl mx-auto mb-20">
          ...
          <h1 className="font-sans font-black text-2xl sm:text-4xl md:text-6xl mb-6">نسعى لتحقيق الرقم القياسي العالمي</h1>
          <p className="text-[var(--muted-light)] text-xl">أكبر عدد من رسائل الشكر الرقمية الموثقة في التاريخ بمليون رسالة</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-5 flex flex-col items-center">
            <div className="relative w-[260px] h-[260px] sm:w-[320px] sm:h-[320px] flex items-center justify-center mb-8">
              ...
              <svg width="320" height="320" viewBox="0 0 320 320" className="transform -rotate-90 drop-shadow-[var(--glow-gold)]">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                <span className="font-mono font-bold text-5xl text-[var(--gold)] tracking-tight">{count.toLocaleString()}</span>
            ...
            <div className="bg-[var(--surface)] border border-[var(--border)] px-8 py-4 rounded-2xl text-center">
              <p className="text-[var(--muted)] text-sm mb-1">متبقي للهدف</p>
              <p className="font-mono text-[var(--gold-light)] text-2xl font-bold">{remaining.toLocaleString()} رسالة</p>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { label: "UUID لكل رسالة", done: true },
                { label: "Timestamp دقيق", done: true },
                { label: "منع التكرار الآلي", done: true },
                { label: "سجلات IP محفوظة", done: true },
                { label: "تصدير CSV جاهز", done: true },
                { label: "تدقيق مستقل", done: false },
              ].map((item, i) => (
        ...
        <div className="mt-16 bg-[#020A04] border border-[var(--green-dim)] rounded-xl p-6 font-mono text-[var(--green-light)] text-sm shadow-[0_0_30px_rgba(63,142,80,0.1)]">
          <div className="flex items-center gap-3 border-b border-[var(--green-dark)] pb-3 mb-4">
            ...
            <span className="text-[var(--green)] ml-4 opacity-70">GWR_VERIFICATION_NODE_01 // LIVE</span>
          </div>
